...
export const useWebRTC = (roomId, user) => {
  ...
  useEffect(() => {
    const initChat = async () => {
      ...
      await captureMedia();
      // Add the local user as a new client
      ...
      // ========== > Event listeners for various socket actions===========
      ...
      // Emit JOIN action to join the room
  ...
  // Function to provide a reference to an audio element
